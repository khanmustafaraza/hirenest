...
const JobAppProvider = ({ children }) => {
  ...
  const handleJobSubmit = async (e) => {
    ...
    const jobObj = {
      categoryName: state.jobFields.categoryName,
      jobTitle: state.jobFields.jobTitle,
      companyName: state.jobFields.companyName,
      companyWebLink: state.jobFields.companyWebLink,
      jobLocation: state.jobFields.jobLocation,
      jobType: state.jobFields.jobType,
      salary: state.jobFields.salary,
      experience: state.jobFields.experience,
      applicationDeadline: state.jobFields.applicationDeadline,
      contactEmail: state.jobFields.contactEmail,
      ...
      jobDescription: state.jobFields.jobDescription
        .split(",")
        .map((i) => i.trim()),
    };
    console.log(jobObj);
  ...
  const getAllJobs = async () => {
    try {
      ...
      if (data.success) {
        ...
        dispatch({ type: "SET_ALL_JOBS", payload: data.data });
      } else {
